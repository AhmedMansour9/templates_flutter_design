...
class SnakeBottomBar extends StatefulWidget {
  const SnakeBottomBar({Key? key}) : super(key: key);

  @override
  _SnakeBottomBarState createState() =>
      _SnakeBottomBarState();
}

class _SnakeBottomBarState
    extends State<SnakeBottomBar> {
    ...
    return Scaffold(
        ...
        child: PageView(
          ...
          children: <Widget>[
            PagerPageWidget(
              ...
              image: Image.asset(Images.avatar),
            ),
            PagerPageWidget(
      ...
      bottomNavigationBar: SnakeNavigationBar.color(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.phone), label: 'microphone'),
          BottomNavigationBarItem(
