...
class _AdminDrawerState extends State<AdminDrawer> {
  ...
  Widget? _getPageWidget(RouteSettings settings) {
    ...
    switch (uri.path) {
      case '/':
        return DashboardPage('Dash Board');
      case '/secondLevelItem1':
        return DashboardPage('Second Level Item1');
      case '/secondLevelItem2':
        return DashboardPage('Second Level Item2');
      case '/thirdLevelItem1':
        return DashboardPage('Third Level Item1');
      case '/thirdLevelItem2':
        return DashboardPage('Third Level Item2');
    }
    return null;
  }
}
